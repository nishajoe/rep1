...
namespace ExceptionHandling5.Category
{
    public class Dog
    {
        ...
        public void AddPet()
        {
            ...
            {
                Console.WriteLine("pet already exist");
            }
        ...
        public void UpdatePet()
        {
            ...
            Pet petToUpdate = dogs.Find(pet => pet.Id == idToUpdate);
            if (petToUpdate != null)
            {
        ...
        public void RemovePet() 
        {
            ...
            Pet petToRemove = dogs.Find(pet => pet.Id == idToRemove);
            if (petToRemove != null)
            {
                dogs.Remove(petToRemove);
